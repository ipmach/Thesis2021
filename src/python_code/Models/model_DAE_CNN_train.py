...
from Models.model_DAE_CNN import DAECNN
from Models.loss import BinaryCross
import tensorflow as tf
import numpy as np


class DAECNN_train(DAECNN, TrainInterface):

    def __init__(self, filters, dim, num_epochs, batch_size,
                 learning_rate, db,  **kwargs):
        """
         Wrapper for the train of  Denoise Autoencoder CNN(Vanilla)
        ...
        """
        super(DAECNN_train, self).__init__(filters, dim, **kwargs)
