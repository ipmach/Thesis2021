...
from Models.model_Vanilla_CNN import VanillaCNN
from Models.loss import BinaryCross
import tensorflow as tf
import numpy as np


class VanillaCNN_train(VanillaCNN, TrainInterface):

    def __init__(self, filters, dim, num_epochs, batch_size,
                 learning_rate, db,  **kwargs):
        """
         Wrapper for the train of  Vanilla Autoencoder CNN(Vanilla)
        ...
        """
        super(VanillaCNN_train, self).__init__(filters, dim, **kwargs)
